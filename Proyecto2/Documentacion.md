...
2. Configurar Elastic y Kibana
   ...
   - Luego en **Dev Tools**, se debe correr el _elastic-script.txt_ en la consola proporcionada por kibana para crear y llenar la BD.
...
- Siempre intentar correr los programas en los ambientes que se van a usar de deployment por medio de una computadora física que tenga el ambiente o una máquina virtual.
...
- La facilidad que provee helm para correr pods con diferentes configuraciones, facilita la experimentación con estos.
- El poder de las herramientas que nos permiten interactuar con los pods como Lens, favoren la utlización de los mismos pods ya que facilitan varios aspectos.
- La utilización de sockets para realizar request a los DNS, permitian crear programas que necesiten estos datos más fáciles de realizar.
